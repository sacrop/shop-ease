...
function submitForm(){
    ...
    hiddenInputs.type='hidden';
    hiddenInputs.name='otp';
    hiddenInputs.value=otp;
    document.getElementById('inputs').appendChild(hiddenInputs);

}
function alertform(event){
    var allowedKeys = ['Backspace', 'ArrowLeft', 'ArrowRight', 'Delete'];
